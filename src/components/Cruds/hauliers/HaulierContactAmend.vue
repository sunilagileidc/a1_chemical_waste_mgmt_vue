...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.haulier_id) {
      this.profile_details.haulier_id = this.$route.query.haulier_id;
    }
  ...
  methods: {
    fetchContact() {
      ...
      this.$axios
        .get("haulierindividual/" + this.$route.query.id)
        .then((res) => {
          if (res.data.status == "S") {
            this.profile_details = res.data.haulier_individual;
          } else {
    ...
    submit() {
      ...
      if (this.$refs.form.validate() && this.valid) {
        ...
        this.$axios
          .post("savehauliercontact", this.profile_details)
          .then((res) => {
            if (res.data.status == "S") {
