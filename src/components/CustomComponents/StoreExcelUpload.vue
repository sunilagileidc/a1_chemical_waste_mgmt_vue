<template>
    <div>
      <v-row v-if="response_data.status">
        <v-col md="12">
          <v-alert
      ...
      <v-row>
        ...
        <v-col md="1">
          <a :href="excelldownloadtemplate" download="storesexcel.xlsx">
    ...
    watch: {
      response_data: {
        ...
        handler() {
          ...
          if (this.response_data.status == "S") {
            ...
            this.fail_message = this.response_data.message;
          }
        },
      },
    },
