        ...
        <div class="card-body">
          <v-form ref="form" v-model="valid">
            ...
            <v-row class="px-4">
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="profile_details.supplier_name"
                  label="Name"
                  variant="outlined"
                  density="compact"
                  :rules="fieldRules"
              ...
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="profile_details.supplier_email"
                  label="Email"
                  variant="outlined"
                  density="compact"
                  :rules="emailRules"
            ...
            <v-row class="px-4">
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="profile_details.supplier_telephone"
                  label="Phone"
                  variant="outlined"
                  density="compact"
                ></v-text-field>
              ...
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="profile_details.supplier_postcode"
                  label="Postcode"
                  variant="outlined"
                  density="compact"
                ></v-text-field>
            ...
            <v-row class="px-4">
              <v-col cols="12">
                <v-textarea
                  v-model="profile_details.supplier_address"
                  label="Address"
                  variant="outlined"
                  density="compact"
                  rows="2"
            ...
            <v-row class="px-4">
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="profile_details.supplier_license"
  ...
  methods: {
    ...
    submit() {
      if (this.$refs.form.validate() && this.valid == true) {
        ...
        this.$axios
          .post("savesupplier", this.profile_details)
          .then((res) => {
            if (res.data.status == "S") {
