          ...
          >
            <template v-slot:item="props">
              <tr class="vdatatable_tbody">
                ...
                <td>
                  {{
                    props.item.rolename || $t("not_appllicable")
                  }}
                </td>
                <td>
                  {{
                    props.item.other_user_details?.length
                      ? props.item.other_user_details
...
export default {
  ...
  methods: {
    ...
    fetchUsers() {
      ...
      this.$axios
        .get("fetch_connected_nurses")
        .then((res) => {
          this.connectedNurses = res.data.usersdata;
          this.connectedNurses = this.connectedNurses.filter((elem) => {
            if (
